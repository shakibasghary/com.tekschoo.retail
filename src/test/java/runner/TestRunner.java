...
@CucumberOptions(
			...
			tags = {"@Register,@login,@sqlquery,@Currency,@AddToCart,@RemoveFromCart,@AddToWishList,@RemoveFromWishList,@CheckOut"}, // we can run all scenarios or one scenario with help of tags
