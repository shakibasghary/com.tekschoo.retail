...
public class LoginPageObj extends Base {
	...
	// PageFactory class provides @FindBy annotations to find UI elements.
	// driver.findElement (by.xpath("//tag[@attribute='value']))
	// the above code is same as below but below's code is used to implement
	...
	// We Start writing public methods to access each element with respecdted
	// actions to them.
